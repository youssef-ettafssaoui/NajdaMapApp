package com.example.verificationnumber.Constant;
...
public interface AllConstant {
    ...
    // PlaceType name will be used to search Near by Places
    // And Name will be used to display it
    // And id will be used to get drawable vectors images
